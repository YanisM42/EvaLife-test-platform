...
def test():
    ...
    program, vec_aero_capa, vec_upper_strength, vec_lower_strength, vec_balance, vec_cumul_reward = test_algorithm(aero_capa, upper_strength, lower_strength, balance, iterations=iterations)
