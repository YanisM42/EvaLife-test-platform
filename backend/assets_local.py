...
ALG_DIR_Yanis = '/Users/yanismarchand/Documents/physical-activity-recommendation/'
ALG_DIR_Yann = '/Applications/MAMP/htdocs/EvaLife-test-platform/backend/physical-activity-recommendation/'
ALG_DIR_server = '/var/www/html/evalife/fshd/server_api/physical-activity-recommendation/'

ALG_DIR = ALG_DIR_server # to change to server before sending to the university server
...
def get_training_week(a, us, ls, b, exercises, interactive=False, iterations=1):

    # A model has to be stored:
    print("=== Use stored model ===")
    # to change:
    # trained_model_name = "/var/www/html/evalife/fshd/server_api/4qualities"
...
def test_algorithm_OLD(a, us, ls, b, interactive=False, iterations=2):
    # Opening JSON file
    with open(ALG_DIR+'out.json', encoding='utf-8') as json_file:
